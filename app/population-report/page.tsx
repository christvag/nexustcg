        ...
        <header className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Population Report</h1>
              <div></div>
            </div>
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-center min-h-96">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Loading Population Data</h2>
              <p className="text-gray-600">Please wait while we fetch the latest grading statistics...</p>
            </div>
          </div>
        </div>
      </div>
